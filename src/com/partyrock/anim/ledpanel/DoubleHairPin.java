 ...
 * 
 */
public class DoubleHairPin extends ElementAnimation {
    ...
    public DoubleHairPin(LightMaster master, int startTime, ArrayList<ElementController> elementList, double duration) {
            ...
            if (fadedcol < colon) {
            	for (int c = fadedcol + 1; c <= colon && c < panel.getPanelWidth(); c++) {
            		if (colon < 4) {
                		...
                		panel.setColor(15 - 7 + c, c, purple);
                		panel.setColor(15 - 8 + c, c, purple);
            		}
            		else if (colon < 8) {
            			panel.setColor(c, c, purple);
                		panel.setColor(c + 1, c, purple);
                		panel.setColor(15 - c, c, purple);
                		panel.setColor(15 - c - 1, c, purple);
            		}
            		else {
